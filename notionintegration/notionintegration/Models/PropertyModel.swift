...
//  notionintegration
//
//  Created by Maegan Wilson on 5/19/21.
//
...
extension Property {
    ...
    public init(from decoder: Decoder) throws {
        ...
        case .title:
            do {
                let value = try container.decode(TypeValue.Title.self, forKey: .init(stringValue: InternalType.title.rawValue)!)
                self.type = .title(value)
            } catch DecodingError.typeMismatch{
                self.type = .title([])
            }
        case .richText:
            let value = try subContainer.decode(TypeValue.RichText.self, forKey: .init(stringValue: InternalType.richText.rawValue)!)
            self.type = .richText(value)
        case .number:
            let value = try container.decode(TypeValue.Number.self, forKey: .init(stringValue: InternalType.number.rawValue)!)
            self.type = .number(value)
        case .select:
            let value = try container.decode(TypeValue.Select.self, forKey: .init(stringValue: InternalType.select.rawValue)!)
            self.type = .select(value)
        case .multiSelect:
            let value = try container.decode(TypeValue.MultiSelect.self, forKey: .init(stringValue: InternalType.multiSelect.rawValue)!)
            self.type = .multiSelect(value)
        case .date:
            let value = try container.decode(TypeValue.Date.self, forKey: .init(stringValue: InternalType.date.rawValue)!)
            self.type = .date(value)
        case .people:
            let value = try container.decode(TypeValue.People.self, forKey: .init(stringValue: InternalType.people.rawValue)!)
            self.type = .people(value)
        case .file:
            let value = try container.decode(TypeValue.File.self, forKey: .init(stringValue: InternalType.file.rawValue)!)
            self.type = .file(value)
        case .checkbox:
            let value = try container.decode(TypeValue.Checkbox.self, forKey: .init(stringValue: InternalType.checkbox.rawValue)!)
            self.type = .checkbox(value)
        case .url:
            let value = try container.decode(TypeValue.Url.self, forKey: .init(stringValue: InternalType.url.rawValue)!)
            self.type = .url(value)
        case .email:
            let value = try container.decode(TypeValue.Email.self, forKey: .init(stringValue: InternalType.email.rawValue)!)
            self.type = .email(value)
        case .phoneNumber:
            let value = try container.decode(TypeValue.PhoneNumber.self, forKey: .init(stringValue: InternalType.phoneNumber.rawValue)!)
            self.type = .phoneNumber(value)
        case .formula:
            let value = try container.decode(TypeValue.Formula.self, forKey: .init(stringValue: InternalType.formula.rawValue)!)
            self.type = .formula(value)
        case .relation:
            let value = try container.decode(TypeValue.Relation.self, forKey: .init(stringValue: InternalType.relation.rawValue)!)
            self.type = .relation(value)
        case .rollup:
            let value = try container.decode(TypeValue.Rollup.self, forKey: .init(stringValue: InternalType.rollup.rawValue)!)
            self.type = .rollup(value)
        case .createdTime:
            let value = try container.decode(TypeValue.CreatedTime.self, forKey: .init(stringValue: InternalType.createdTime.rawValue)!)
            self.type = .createdTime(value)
        case .createdBy:
            let value = try container.decode(TypeValue.CreatedBy.self, forKey: .init(stringValue: InternalType.createdBy.rawValue)!)
            self.type = .createdBy(value)
        case .lastEditedTime:
            let value = try container.decode(TypeValue.LastEditedTime.self, forKey: .init(stringValue: InternalType.lastEditedTime.rawValue)!)
            self.type = .lastEditedTime(value)
        case .lastEditedBy:
            let value = try container.decode(TypeValue.LastEditedBy.self, forKey: .init(stringValue: InternalType.lastEditedBy.rawValue)!)
...
extension Property.TypeValue {
    public typealias Title = [RichText]
